...
param M3; # número suficientemente grande como para que supere la cantidad máxima de descansos que se podrían tomar en una ciudad
...
var TE{ i in CIUDADES}; # Tiempo de estadia en la ciudad i
...
var D{ i in CIUDADES}, integer; # Representa la cantidad de descansos que debe realizar el equipo en la ciudad i. 
var T{ i in CIUDADES, j in CIUDADES}, integer; # Vale Di si Wij es 1, sino 0.
